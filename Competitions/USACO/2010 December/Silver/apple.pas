...
begin
  ...
  if idx[pa1].razdaljina<idx[pa2].razdaljina
    then begin
           resenje:=idx[pa1].razdaljina;
           isprazni;
           idx[pa1].razdaljina:=0;
           ph:=0;
           push(pa1);
           dijkstra(pa1);
           writeln(resenje+idx[pa2].razdaljina);
         end
    else begin
           resenje:=idx[pa2].razdaljina;
           isprazni;
           idx[pa2].razdaljina:=0;
           ph:=0;
           push(pa2);
           dijkstra(pa2);

           writeln(resenje+idx[pa1].razdaljina);
         end;
  close(output);
end.
